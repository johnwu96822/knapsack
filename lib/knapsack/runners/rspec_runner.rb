    ...
    class RSpecRunner
      def self.run(args)
        ...
        if allocator.stringify_node_tests.empty?
          ...
          files = 'spec/features/suppliers/supplier_request_info_displays_latest_response_status_spec.rb spec/features/easy_forms/sim/supplier_manager_role_permissions_disable_sim_spec.rb spec/features/contracts/overwrite_payment_and_shipping_term_permission_spec.rb'
